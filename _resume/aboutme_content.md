...
안녕하세요. 유니티를 주로 사용하는 클라이언트 프로그래머 “문동준“입니다. 현재 재직 중인 회사에서 6년간 근무하며 `오버독스`, `데미안전기` 두 프로젝트를 초기 개발부터 글로벌 출시까지 담당하였으며, 현재까지 라이브 서비스 운영 중입니다. 또한, `신규 내부 프로젝트 개발`을 진행하고 있습니다. 경험과 노하우를 바탕으로 안정적인 서비스와 최적화된 개발을 목표로 하고 있습니다.
